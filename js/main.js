...
document.addEventListener('DOMContentLoaded', function () {
    new Typed('.home_title #subtitle', {
        strings: ['Hello, I am a creative, conceptual UI/UX, Front-end and Mobile developer.', 'I like to do user interface design, animation and graphic design.', 'I create beautiful and user-friendly design for websites and applications.'],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
    ...
    $('.popup-link').magnificPopup({
        ...
        image: {
            titleSrc: function (item) {
                return item.el.attr('title') + '<small>by Olzhas Gabdullin</small>';
            }
        }
    });
